...
- To create a site that is simple in appearance by adding a background with terminal view embedded.
...
Implementation:
* Anterminlal screen will be viewable on the website
...
Design:
I wanted to have some visuals for the user and decided to have a background for the battleship game.
